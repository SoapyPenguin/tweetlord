		...
		<div id="about-modal" class="modal fade" role="dialog">
  		...
  		<div class="game-content">
			<div class="ph0-content">
				...
				<div class="ph0-timer"><span class="label label-primary ph0-tick" align="center" style="font-size:300%;"></span></div>
...
$(document).ready(function() {
	...
	function rollPh0Colors() {
		var c = ['#800000','#804000','#408000','#008020','#008080','#002080','#400080','#800060'];
